# Eskwelabs Chatbot
This project focuses on the end-to-end development of a Q&A Chatbot tailored to answer bootcamp-related queries, specifically for Eskwelabs. The guide covers the key steps, including embedding techniques, developing a Retrieval-Augmented Generation (RAG) chatbot using LangChain, and deploying the chatbot via Streamlit. 
...
For this step, the documents are embeddings and stored in the vector database called `embeddings_practicev1` located in this repository. 
...
![image](https://github.com/user-attachments/assets/067ff3d4-d059-4955-8377-3a8976270ba0)
...
## App Preview
The guide was meant to help users deploy their own Q&A chatbot locally using open-source LLMs. However, the chatbot can be deployed easier via Streamlit by getting access to an LLM through an API key. View the deployed project [here](https://askwelabscapstoneproject.streamlit.app/).
...
load_dotenv()
```
- Use LangSmith to trace whether the output calls the appropriate tool/s
![image](https://github.com/user-attachments/assets/edb93ccb-53eb-4f4e-af9f-21db1b9d30d6)

- It can be seen that the appropriate tool was called, `eskwelabs_bootcamp_info_search` 
![image](https://github.com/user-attachments/assets/6e40c0f6-dcb4-4553-b1cb-5e07445cc87a)
